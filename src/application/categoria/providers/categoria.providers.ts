...
export const CategoriaProdutosProviders: Provider[] = [
   { provide: CategoriaProdutoConstants.ISERVICE, useClass: CategoriaProdutoService },
   {
      ...
      inject: [CategoriaProdutoConstants.IREPOSITORY, ProdutoIntegration],
      useFactory: (repository: IRepository<CategoriaProduto>, produtoIntegration: ProdutoIntegration): BuscarTodasCategoriasUseCase =>
         new BuscarTodasCategoriasUseCase(repository, produtoIntegration),
   },
];
