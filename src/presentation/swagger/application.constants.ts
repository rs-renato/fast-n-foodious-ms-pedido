export class SwaggerConstants {
  ...
  public static readonly SWAGGER_VERSION: string = '3.0.0';
  ...
  public static readonly SWAGGER_EXTERNAL_DOC_DESCRIPTION: string = '🔗 Github Fast & Foodious';
  public static readonly SWAGGER_EXTERNAL_DOC_URL: string = 'https://github.com/rodrigo-ottero/fast-n-foodious';
}
